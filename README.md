...
The heatmap above answers it. Each column is a cell, the two rows are sessions. A cell that
stays red or blue across both is real signal; a lone off-color square is noise. Cells **31**
and **67** light up in both healthy sessions, and both turned out to be driving an active fault.

## Cell 43 and the P0A80 fault
